...
then
  ...
  then
    ...
    for i in $(sudo fish --command="source /root/.config/fish/functions/fundle.fish; and fundle list | command grep -v 'https://github.com'")
    do
      [ -d $conf/fish/fundle/$i/completions ] && ( sudo chmod a+x /root/.config/fish/fundle/$i/completions/* && sudo ln -v /root/.config/fish/fundle/$i/completions/* $conf/fish/conf.d/completions/ )
      [ -d $conf/fish/fundle/$i/functions ] && ( sudo chmod a+x /root/.config/fish/fundle/$i/functions/* && sudo ln -v /root/.config/fish/fundle/$i/functions/* $conf/fish/conf.d/functions/ )
    done
  fi
